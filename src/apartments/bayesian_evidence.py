...
def load_evidence(dataset, evidence):
    ...
    from .direct_floor_projection import SIDECAR as DIRECT_FLOOR_SIDECAR
    dataset_manifest, dataset_files = _verified_bundle(dataset, retain={'observations.jsonl', SIDECAR, ELEVATOR_SIDECAR, FLOOR_LABEL_SIDECAR, EXPANDED_FLOOR_SIDECAR, RESIDUAL_SCOPE_SIDECAR, DIRECT_FLOOR_SIDECAR})
