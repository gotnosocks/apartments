...
ALTER TABLE buildings ADD COLUMN IF NOT EXISTS has_floor_13 BOOLEAN;

ALTER TABLE listings ADD COLUMN IF NOT EXISTS building_slug VARCHAR;
ALTER TABLE listings ADD COLUMN IF NOT EXISTS floor INTEGER;
ALTER TABLE listings ADD COLUMN IF NOT EXISTS physical_floor INTEGER;
...
ALTER TABLE listings ADD COLUMN IF NOT EXISTS is_garden_facing BOOLEAN;
ALTER TABLE listings ADD COLUMN IF NOT EXISTS is_street_facing BOOLEAN;
