    ...
    return pd.DataFrame(
        {
            ...
            "listed_floor": rng.integers(1, 20, n),
...
def test_sorted_serialization_roundtrip_preserves_every_named_column(
    data, tmp_path, spec
):
...
def test_versioned_floor_loader_preserves_order_and_rejects_wrong_prior(data, tmp_path):
    ...
    design = floor.FeatureDesign(data)
    ...
    with pytest.raises(ValueError, match="prior"):
        load_design(tmp_path, data, protocol)
