...
def test_render_report_has_denominators_and_quality_limits():
    text = render_report({
        ...
        "listing_observations": {
            ...
            "missingness_by_listing_type": {"rental": {"bedrooms": 1, "bathrooms": 0, "square_feet": 0, "room_count": 2}, "sale": {"bedrooms": 0, "bathrooms": 1, "square_feet": 0, "room_count": 0}},
            "json_completeness_by_listing_type": {"rental": {"features_json": {"missing": 1, "empty": 1, "nonempty": 1}}},
            "attribute_disagreement_count": 1,
            "source_pair_attribute_disagreement_count": 2,
        },
        "event_mentions": {"price": {"positive": 2}, "dates": {"parseable": 3}, "years": {"min": 2020, "max": 2024}, "event_key": {"rows": 3, "distinct": 2, "duplicate_rows": 1}},
        "numeric": {"listing_observations": {"bedrooms": {"non_null": 4, "invalid": 1}}},
        "provenance": {"snapshot": "/archive/input.sqlite3", "version": "granular-v1", "corrections": {"enabled": False, "record_count": 0}},
