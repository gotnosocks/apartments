...
@pytest.mark.parametrize('text, expected', [
    ...
    ('Gallery/office commercial condo for showroom and retail events', 'retail_showroom'),
    ('2000 square feet of ground floor retail space for short term lease.', 'retail_showroom'),
