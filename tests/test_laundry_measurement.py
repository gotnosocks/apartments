...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Laundry is right on the floor just steps away from the apartment.",
            [],
            "on_floor",
        ),
        ("The building laundry room is down the hall from 2B.", [], "on_floor"),
        (
            "Complimentary laundry with a brand new washer and dryer on your floor!",
            [],
            "on_floor",
        ),
        ("Laundry and roof deck right on the floor.", [], "on_floor"),
        (
            "Residents here enjoy the convenience of a washer/dryer on every floor, as well as a common outdoor terrace.",
            [],
            "on_floor",
        ),
        (
            "The building has laundry with new machines on every floor, a bike room, and full-time super.",
            [],
            "on_floor",
        ),
        (
            "Residents have access to a washer and dryer on each residential floor.",
            [],
            "on_floor",
        ),
        ...
        (
            "Laundry with new machines on every floor will be installed next year.",
            [],
            None,
        ),
        ...
        (
            "Residents have access to a washer/dryer on every floor of their duplex.",
            [],
            None,
        ),
        ("Residents will have access to a washer/dryer on every floor.", [], None),
        (
            "Residents have access to a washer/dryer on every floor except the first.",
            [],
            None,
        ),
        ...
        (
            "Getting your laundry done will be easy with an in-unit washer and dryer.",
            ["WASHER_DRYER"],
            "in_unit",
        ),
        (
            "A separate room could be utilized as a bedroom with a washer/dryer.",
            ["WASHER_DRYER"],
            "in_unit",
        ),
        (
            "A washer/dryer and fireplace! What more could you want?",
            ["WASHER_DRYER"],
            "in_unit",
        ),
        (
            "Residents will enjoy the convenience of an in-home washer and dryer.",
            ["WASHER_DRYER"],
            "in_unit",
        ),
        (
            "The kitchen will include new appliances with a dishwasher and washer dryer in unit.",
            ["WASHER_DRYER"],
            None,
        ),
        (
            "The bathroom will have an elegant shower and in-unit washer/dryer.",
            ["WASHER_DRYER"],
            None,
        ),
...
def test_same_floor_implies_shared_access_but_not_private_equipment():
    ...
    assert result["states"] == {
        "private": None,
        "shared_building": True,
        "shared_same_floor": True,
    }
...
def test_shared_room_denial_does_not_establish_private_equipment_absence():
    ...
    assert result["states"] == {
        "private": None,
        "shared_building": False,
        "shared_same_floor": False,
    }
    assert result["most_convenient_reported_option"] is None
