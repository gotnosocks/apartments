...
def capture():
    raw = json.dumps({'id': 123, 'description': '$L1',
                      'propertyDetails': {'amenities': {'list': ['LAUNDRY']}}})
    text = 'Laundry on every floor.'
    row = {'source_listing_id': '123', 'building': 'b',
           'analysis_price_basis': 'historical_initial_own_advertisement_ask', 'laundry_type': 'in_building'}
    evidence = {'audit_id': 'a', 'capture_id': 42, 'source_listing_id': '123', 'unit_id': 'u',
                'body_sha256': 'body', 'raw_listing_sha256': hashlib.sha256(raw.encode()).hexdigest(),
                'description_sha256': hashlib.sha256(text.encode()).hexdigest(), 'description': text,
                'source_collected_at': '2025-01-01T00:00:00Z', 'known_at': '2025-01-01T00:00:00Z',
                'description_interpreted_at': '2026-09-19T00:00:00Z', 'source_path': '/description'}
